...
(function () {
    ...
    var settings = require("./server.settings.json"),
        ...
        mimetypes = {
            ...
            ".css": ["text/css"], //["application/x-pointplus", "text/css"]
            ".cxx": ["text/plain"],
            ...
            ".jps": ["image/x-jps"],
            ".js": ["text/javascript"], //["application/x-javascript", "application/javascript", "application/ecmascript", "text/javascript", "text/ecmascript"],
            ".jut": ["image/jutvision"],
