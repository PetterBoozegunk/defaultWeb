...
var gulp = require("gulp"),
    ...
    mainLessPipe = lazypipe().pipe(plugins.less, settings.options).pipe(plugins.shorthand).pipe(plugins.pleeease, settings.pleeease).pipe(plugins.stripCssComments, settings.comments),
