...
var gulp = require("gulp"),
    ...
    mainLessPipe = lazypipe().pipe(plugins.less, settings.options).pipe(plugins.pleeease, settings.pleeease).pipe(plugins.shorthand).pipe(plugins.stripCssComments, settings.comments),
